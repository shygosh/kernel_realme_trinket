...
#ifdef CONFIG_VENDOR_EDIT //YiXue.Ge@PSW.BSP.Kernel.Stablity, 2018-10-26 add for enable pmic wd
...
#ifdef CONFIG_VENDOR_EDIT /* yanghao@PSW.Kernel.Stability add for debug suspend crash problem */
