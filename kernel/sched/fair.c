...
unsigned int sched_capacity_margin_up[NR_CPUS] = {
			[0 ... NR_CPUS-1] = 1024}; /* 0 margin */
unsigned int sched_capacity_margin_down[NR_CPUS] = {
			[0 ... NR_CPUS-1] = 1137}; /* ~10% margin */
...
__read_mostly unsigned int sysctl_sched_prefer_spread = 2;
#endif
...
{
	unsigned int nr_running = (sched_feat(ALT_PERIOD) ?
